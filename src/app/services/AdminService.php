...
class AdminService
{
    ...
    public function delete(): string|null
    {
        ...
        try {
            ...
            if (isset($delete_id_codes)) {
                ...
                $query = $this->connection->prepare('DELETE FROM dates WHERE code_id = :id');
        ...
        try {
            ...
            if (isset($insert_id_codes)) {
                ...
                $query = $this->connection->prepare(
                    'INSERT INTO codes (language, slug, code, output, date)
                     VALUES (:language, :slug, :code, :output, :date)'
                );
                ...
                $query = $this->connection->prepare(
                    'INSERT INTO dates (code_id, date) VALUES (:code_id, :date)'
                );
    ...
    public function edit(): string|null
    {
        ...
        try {
            ...
            } else if (isset($edit_id_dates)) {

                $query = $this->connection->prepare(
                    'UPDATE dates SET date = :date, code_id = :code_id WHERE id = :id'
                );
